...
export const FONT_COLOR = ['rgb(216,57,49)', 'rgb(222,120,2)', 'rgb(220,155,4)', 'rgb(46,161,33)', 'rgb(36,91,219)', 'rgb(100,37,208)', 'rgb(143,149,158)']
    ...
    rules: {
        string: [
            ...
            },
            {
                ...
                syntax: [
                    'word',
                    '随机生成大于等于3小于等于10个字母的英文单词',
                    'word|len',
                    '生成指定字母个数的单词',
                    'word|min-max',
                    '随机生成大于等于min小于等于max个字母的英文单词',
                ],
            ...
            },
            {
                ...
                syntax: [
                    'datetime',
                    '随机生成一个(Y-M-D H:I:S)格式的日期时间',
                    'datetime|format',
                    '随机生成一个指定格式的日期时间，format为(YyMmDd HhIiSs)的排列组合',
                ],
                example: [
                    'datetime',
                    '-> 2020-03-17 09:00:00',
            ...
            },
            {
                ...
                example: [
                    'fileurl',
                    '-> http://mock.apicat.net/file/welcome_to_use_apicat.md',
                    'fileurl|csv',
                    '-> http://mock.apicat.net/file/welcome_to_use_apicat.csv',
                ],
            },
        ],
        int: [
        ...
        object: [
            {
                ...
                example: [
                    '// 对象obj',
                    'obj = {"username": string|6, "password": string|6}',
                    '// 对象obj的规则及结果',
                    'object',
        ...
        file: [
            {
                ...
                syntax: [
                    'file',
                    '生成一个Markdown文件，以文件流的方式返回',
                    'file|type',
                    '生成一个指定类型的文件，以文件流的方式返回，类型type只支持word、excel、csv、md',
                ],
