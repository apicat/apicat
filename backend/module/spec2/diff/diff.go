...
func compareHttpParameters(a *spec2.HTTPParameters, b *spec2.HTTPParameters) {
	aMap := a.ToMap()
	bMap := b.ToMap()
	for _, typ := range spec2.HttpParameterType {
...
func compareParameterList(a, b spec2.ParameterList) spec2.ParameterList {
...
func compareParameter(a, b *spec2.Parameter) bool {
	change := false
...
func compareContent(a, b spec2.HTTPBody) spec2.HTTPBody {
	names := map[string]struct{}{}
	aBody, bBody := &spec2.Body{}, &spec2.Body{}
...
func compareRequest(a, b *spec2.CollectionHttpRequest) {
...
func compareResponse(a, b *spec2.CollectionHttpResponse) *spec2.CollectionHttpResponse {
...
// Same returns true otherwise false
func compareParamBasicInfo(a *spec2.Parameter, b *spec2.Parameter, onlyRequired bool) bool {
	if onlyRequired {
