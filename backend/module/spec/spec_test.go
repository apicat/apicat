...
func TestDereferenceSchema(t *testing.T) {
	...
	parent := source.Definitions.Schemas.LookupByID(2068)
	sub := source.Definitions.Schemas.LookupByID(2332)
...
func TestDereferenceSelf(t *testing.T) {
	...
	onlySelf := source.Definitions.Schemas.LookupByID(2332)
...
func TestResponseRef(t *testing.T) {
	...
	resp := source.Definitions.Responses.LookupByID(378)
	// resp1 := source.Definitions.Responses.LookupID(378)
	// rr := []*HTTPResponseDefine{
	// 	resp, resp1,
	// }
	for _, c := range source.Collections {
		c.DerefResponse(resp)
	}
...
// 	for _, c := range source.Collections {
// 		c.DelGlobalParameterExcept("path", source.Globals.Parameters.Path.LookupID(34).ID)
// 	}
