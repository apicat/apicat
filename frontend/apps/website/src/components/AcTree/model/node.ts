...
import type { FakeNode, TreeNodeChildState, TreeNodeData, TreeNodeLoadedDefaultProps, TreeNodeOptions } from '../tree.type'
...
class Node {
    ...
    updateChildren(): void {
        ...
        newData.forEach((item, index) => {
            ...
            const isNodeExists = !!key && oldData.findIndex((data: any) => data[NODE_KEY] === key) >= 0
            if (isNodeExists) {
