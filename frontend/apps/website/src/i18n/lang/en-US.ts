      ...
      model: {
        ...
        azure: {
          ...
          rules: {
            ...
            llm: 'Please select LLM',
            llmDevName: 'LLM deployment name name is required',
            embedding: 'Please select Embedding model',
            embeddingDevName: 'Embedding model deployment name is required',
            llmAndEmbedding: 'Please select LLM or Embedding model',
          },
        },
      },
      users: {
