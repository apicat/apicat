...
export const getDocumentDetailPath = (project_id: number | string, doc_id: number | string) => compile(DOCUMENT_DETAIL_PATH)(resetEmptyPathParams({ project_id, doc_id }))
export const getDocumentEditPath = (project_id: number | string, doc_id: number | string) => compile(DOCUMENT_EDIT_PATH)(resetEmptyPathParams({ project_id, doc_id }))
