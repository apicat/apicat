...
export const getSchemaDetailPathWithIterationId = (iteration_id: number | string, schema_id: number | string) => compile(ITERATION_SCHEMA_DETAIL_PATH)({ iteration_id, schema_id })
export const getSchemaEditPathWithIterationId = (iteration_id: number | string, schema_id: number | string) => compile(ITERATION_SCHEMA_EDIT_PATH)({ iteration_id, schema_id })
