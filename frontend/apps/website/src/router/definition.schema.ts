...
export const getSchemaDetailPath = (project_id: number | string, schema_id: number | string) => compile(SCHEMA_DETAIL_PATH)(resetEmptyPathParams({ project_id, schema_id }))
export const getSchemaEditPath = (project_id: number | string, schema_id: number | string) => compile(SCHEMA_EDIT_PATH)(resetEmptyPathParams({ project_id, schema_id }))
